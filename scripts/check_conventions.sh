...
SOFT_MODELS="Transaction\|Account\|CounterpartyCategory\|Override\|IntegrationKey\|PlannedPayment\|PlannedIncome\|WbPayout\|PaymentFactLink\|CostOrder\|CostOrderItem\|DutyRule\|CustomsTopup\|CustomsDT\|Order\|CategoryRef\|CategoryRule\|WbTariff\|Warehouse\|InboundReceipt\|OutboundShipment\|StockTransfer\|AssemblyRequest\|ProductTag\|FactoryOrder\|FactoryOrderItem\|Project\|ProjectMember\|AiConversation\|VehicleDocument\|Supplier\|DefectMarkOperation\|Counterparty\|CounterpartyDocument\|Loan\|WbGoodsReturn"
