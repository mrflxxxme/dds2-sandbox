...
from backend.services.reports.dashboard_ops import get_dashboard_operations
...
async def test_empty_project_returns_full_shape_all_zero(db_session, project):
    ...
    assert all(out[k] == 0 for k in _EXPECTED_KEYS)
