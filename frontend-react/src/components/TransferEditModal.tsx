...
/**
 * Правка переезда ДО ОТГРУЗКИ: маршрут, комментарий, брак, транспортная
 * единица, состав. Бэкенд разрешает PUT в PENDING / IN_PROGRESS / READY
 * (TRANSFER_EDITABLE_STATUSES) — пока сток не списан; кнопку, открывающую эту
 * модалку, карточка в остальных статусах не показывает вовсе.
 *
