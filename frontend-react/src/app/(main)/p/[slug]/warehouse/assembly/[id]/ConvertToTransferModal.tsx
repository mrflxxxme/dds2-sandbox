 ...
 *
 * Чекбокс «перенести связку ФФ» по умолчанию ВЫКЛЮЧЕН и управляет только
 * ЗАВЕРШЁННЫМИ зеркалами — они остаются историей заявки. НЕзавершённые уезжают
 * на переезд всегда, когда переделка отменяет заявку: работа у провайдера
 * открыта и делается физически под этот переезд, бросать её на отменённом
 * документе нельзя (прод ASM-770 → TR-32).
 *
            ...
            <div className="modal-card" onClick={e => e.stopPropagation()} style={{ maxWidth: 520 }}>
                ...
                <div className="form-group" style={{ borderTop: '1px solid var(--color-border)', paddingTop: 12 }}>
                    ...
                    <div style={{ fontSize: 12, color: 'var(--color-text-muted)', marginTop: 6 }}>
                        Незавершённые заявки ФФ переедут сами — галка нужна, только чтобы забрать
                        и завершённые (историю сборки).
                    </div>
                </div>
