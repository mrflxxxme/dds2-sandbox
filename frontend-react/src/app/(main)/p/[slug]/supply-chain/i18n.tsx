...
const ru: TranslationDict = {
    ...
    paste_price_mismatch: 'с параметрами, отличающимися от заказа (цена / коробка / шт/кор)',
    paste_mismatch_title: 'Параметры отличаются от заказа',
...
const zh: TranslationDict = {
    ...
    paste_price_mismatch: '项参数与订单不同（价格/箱规/件每箱）',
    paste_mismatch_title: '参数与订单不一致',
