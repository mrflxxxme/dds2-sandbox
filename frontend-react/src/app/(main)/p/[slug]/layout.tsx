...
const itemIcons: Record<string, React.ReactNode> = {
    ...
    '/salary': <Icon><rect width="20" height="12" x="2" y="6" rx="2" /><circle cx="12" cy="12" r="2" /><path d="M6 12h.01" /><path d="M18 12h.01" /><path d="M16 21v-2a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2" /></Icon>,
    // Справочники
    ...
    '/card-exchange': <Icon><rect width="18" height="14" x="3" y="5" rx="2" /><path d="M7 10h7l-2-2" /><path d="M17 14h-7l2 2" /></Icon>,
...
const navGroups: { title: string; section: string; items: NavItem[] }[] = [
    {
        ...
        items: [
            ...
            { href: '/salary', label: 'Зарплата', icon: '💵', pageKey: 'salary' },
        ],
    },
    {
        title: 'Справочники',
    ...
    },
    {
        ...
        items: [
            ...
            { href: '/design-tasks', label: 'Дизайн карточек', icon: '🖌️', pageKey: 'design-tasks' },
