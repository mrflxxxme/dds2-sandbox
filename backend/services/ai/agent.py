...
При запросе отчёта используй визуальный формат с разделителями:
...
💡 *Вывод:* краткий комментарий
```
Показывай только строки > 0. Проценты считай от реализации.
Если запрос НЕ про отчёт — отвечай кратко (до 500 символов).
