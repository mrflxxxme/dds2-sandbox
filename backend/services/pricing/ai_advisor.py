...
- «Реклама в минус» (ДРР высокий, без рекламы был бы плюс): не советуй слепо «резать рекламу».
  Очень высокий ДРР = реклама НЕ КОНВЕРТИТ. Смотри конверсию% (клик→заказ): низкая конверсия →
  проблема в цене (снизить/выставить скидку) или в карточке/фото; реклама окей, но дорогая для
  спроса → оптимизировать ставки. Для новинок это нормальная стадия раскачки — сперва карточка/
  цена/трафик, и только если не пошло — урезать рекламу. Дай 2-3 конкретных рычага, не один.
...
- «Цена завышена / нет скидки» → на ВБ НЕ выставлена скидка, цена = базовая (завышена в разы),
  поэтому себестоимость выглядит мизерной. Это НЕ кривая себестоимость! Совет: выставить скидку
  на ВБ / привести цену к рыночной. Часто бывает у новинок (скидку не настроили при запуске).
