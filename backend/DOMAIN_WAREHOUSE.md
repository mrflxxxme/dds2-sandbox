...
### WB FBO поставки
- Статусы (read-only из WB): ACTIVE (Запланирована), ON_DELIVERY (В пути), IN_PROGRESS (Разгрузка разрешена), ACCEPTED (Принята, финальный), CANCELLED (Отменена, финальный).
