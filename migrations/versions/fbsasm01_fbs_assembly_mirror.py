...
⚠️ Цепочка: за rbac01_pages_upd — ЛОКАЛЬНЫЙ хвост ветки feat/main-tree-port
(rbac01 на момент создания вообще не закоммичен — параллельная сессия).
Если rbac01/payroll-цепочку перецепят или отбросят, down_revision надо
перецепить следом.
"""
