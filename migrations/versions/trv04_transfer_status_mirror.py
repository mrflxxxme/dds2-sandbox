...
# Цепляемся за mfp01 (поставка у Натали из перемещения), а не за trv03: обе ветки
# росли из trv03 параллельно, и на dev-базе первой оказалась mfp01. Две головы
# alembic — грабля, на которой в проекте уже стояли.
down_revision: str | None = "mfp01_migfull_order_transfer"
