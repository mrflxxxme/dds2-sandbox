...
> **Канон lead-agent DDS2.** Источник правды для роли tech lead. При противоречии с другими файлами — приоритет у этого документа. Обновления только по явному запросу владельца. Краткая специфика 4.7 — в [docs/OPUS_4_7_MIGRATION.md](../../docs/OPUS_4_7_MIGRATION.md).
