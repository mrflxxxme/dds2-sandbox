...
- [Design ON_HOLD/REVISION gap](design-onhold-revision-gap.md) — «Дизайн карточек»: REVISION→ON_HOLD есть, обратно нет; held_from_status='REVISION' тупиковый (ревью Ф0)
